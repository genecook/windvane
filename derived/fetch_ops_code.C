   ...
   case ADCS_64:
      ...
      break;
   case ADD_REG_32:
      packet->mOpsFetch.push_back(RNSP);
      packet->mOpsFetch.push_back(RM);
      break;
   case ADD_REG_64:
      packet->mOpsFetch.push_back(RNSP);
   ...
   case STLRH:
      ...
      break;
   case STLXP_32:
      packet->mOpsFetch.push_back(RS);
      packet->mOpsFetch.push_back(RT);
      packet->mOpsFetch.push_back(RT2);
      packet->mOpsFetch.push_back(RNSP);
      break;
   case STLXP_64:
      packet->mOpsFetch.push_back(RS);
      packet->mOpsFetch.push_back(RT1);
      packet->mOpsFetch.push_back(RT2);
      packet->mOpsFetch.push_back(RNSP);
      break;
   case STLXR_32:
   ...
   case SIMD_ABS_REG_VEC:
      packet->mOpsFetch.push_back(VN);
      break;
   case SIMD_ADD_SCALAR_VEC:
      break;
   case SIMD_ADD_VEC_VEC:
      packet->mOpsFetch.push_back(VN);
      packet->mOpsFetch.push_back(VM);
      break;
   case SIMD_ADDHN:
      if (packet->Q==0) {
      packet->mOpsFetch.push_back(VN);
   ...
   case FADD_SINGLE_FROM_SP:
      packet->mOpsFetch.push_back(SN);
      packet->mOpsFetch.push_back(SM);
      break;
   case FADD_FROM_DP:
      packet->mOpsFetch.push_back(DN);
      packet->mOpsFetch.push_back(DM);
      break;
   case SIMD_FADDP:
      packet->mOpsFetch.push_back(VN);
      break;
   ...
   case FMADD_SINGLE_FROM_SP:
      packet->mOpsFetch.push_back(SN);
      packet->mOpsFetch.push_back(SM);
      packet->mOpsFetch.push_back(SA);
      break;
   case FMADD_FROM_DP:
      packet->mOpsFetch.push_back(DN);
      packet->mOpsFetch.push_back(DM);
      packet->mOpsFetch.push_back(DA);
      break;
   case SIMD_FMAX_VEC:
      packet->mOpsFetch.push_back(VN);
      packet->mOpsFetch.push_back(VM);
   ...
   case SIMD_LD1_FOUR_REG_MULT_STRUCT:
      ...
      packet->mOpsFetch.push_back(VT3);
      packet->mOpsFetch.push_back(VT4);
      packet->mOpsFetch.push_back(RNSP);
      break;
   ...
   case SIMD_LDUR_IMM_REG_64:
      packet->mOpsFetch.push_back(DT);
      packet->mOpsFetch.push_back(RNSP);
      break;
   case SIMD_LDUR_IMM_REG_16:
      packet->mOpsFetch.push_back(HT);
      packet->mOpsFetch.push_back(RNSP);
      break;
   ...
   case SIMD_STNP_OFF_64:
      packet->mOpsFetch.push_back(DT);
      packet->mOpsFetch.push_back(DT2);
      packet->mOpsFetch.push_back(RNSP);
      break;
   ...
   case SIMD_STNP_OFF_32:
      packet->mOpsFetch.push_back(ST);
      packet->mOpsFetch.push_back(ST2);
      packet->mOpsFetch.push_back(RNSP);
      break;
