...
Usage, redistribution or deployment of this software for commercial purposes will require
a commercial license. Licenses are available both for the (existing) binary release, or
for a (pending) source code release.
